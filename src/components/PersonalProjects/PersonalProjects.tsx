...
export default function PersonalProject() {
  ...
  return (
    <section className="relative">
      ...
      {/* Content */}
      <ScrollWrapper name="projetos-pessoais" className="mt-8">
        ...
        <div className="relative flex min-h-[200px] w-full items-center gap-2">
          {loading && (
            <Loader2
              className="absolute left-1/2 top-[40%] -ml-8 animate-spin text-azul-200"
              width={68}
              height={68}
            />
          )}
