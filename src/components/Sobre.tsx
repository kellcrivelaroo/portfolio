...
export default function Sobre() {
  return (
    <section className="mt-10 flex flex-col items-center p-12 pb-4" id="sobre">
      <div className="flex flex-col rounded-full border-8 border-gray-100 shadow-md shadow-azul-200/60">
        <Image src={avatar} width={200} height={200} alt="Kell" />
      </div>
      <div className="flex w-full flex-col items-center justify-center gap-8 py-12">
        <p className="text-justify indent-10 text-xl leading-normal">
